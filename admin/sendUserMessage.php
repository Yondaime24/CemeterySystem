...
<body class="animsition">
  <div class="page-wrapper">
      ...
      <?php if ($row['user_type']=='user') { ?>
          ...
          <form id="messageForm" action="sendUserMessage.php" method="post">
            ...
            <div>
                <button  class="btn btn-success btn-block" type="submit" name="sendUserMsg">Send</button>
            </div>
      ...
      <?php }else { ?>
        ...
        <form id="messageForm" action="sendUserMessage.php" method="post">
            ...
            <div>
                <button  class="btn btn-success btn-block" type="submit" name="sendadminMsg">Send</button>
            </div>
