                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td>
                                    <a class=\"btn btn-sm btn-outline-primary btn-block\" href=\"deceasedEdit.php?deceased_id=$res[deceased_id]&&reserve_id=$res[reserve_id]&&loc_id=$res[loc_id]&&user_id=$res[user_id]\">View Details</a>

                                     <a class=\"btn btn-sm btn-outline-danger btn-block\" href=\"deceasedDelete.php?deceased_id=$res[deceased_id]&&reserve_id=$res[reserve_id]\&&loc_id=$res[loc_id]&&user_id=$res[user_id]\" onClick=\"return confirm('Are you sure that you want to delete this deceased details?' )\">Delete</a> 
                                    </td>";  
                                  echo "</tr>";                                   
                              }
                            }?>
