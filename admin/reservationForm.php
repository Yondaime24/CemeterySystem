...
<body class="animsition">
  <div class="page-wrapper">
              <div class="login-wrap">
                  <div class="login-content">
                      <div class="login-logo">
                        ...
                        <br>
                         <a href="viewUser.php" class="btn btn-sm btn-primary">Return</a>
                      </div>
    ...
    <form id="reservationForm" action="reservationForm.php" method="post">
            ...
            <center>
              <span><b>Add User Reservation</b></span>
            </center>
            ...
            <div class="form-group">
              ...
              <input id="userID" name="reserved_by" type="text" class="form-control" value="<?php echo $row['fname'];?> <?php echo $row['mname'];?> <?php echo $row['lname'];?>" readonly>
            </div>
          ...
          <?php }?>
            ...
            <div class="row">
             ...
             <div class="form-group validate">
              ...
              <div>
                <button  class="btn btn-primary btn-block" type="submit" name="addUserReservation">Add Reservation</button>
              </div>
              <div style="margin-top: 10px;">
                <a class="btn btn-block btn-secondary" href="viewUser.php">Cancel</a>
              </div>
                </form>
                  </div>
              </div>
