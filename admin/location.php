<?php  
  ...
  $sql2 = "SELECT sum(price) AS total FROM location";
  $stmt2 = $db->query($sql2);
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <section class="statistic">
            	<div class="container-fluid" style="margin-top: 20px; background: transparent;">
              <div class="card mb-3" style="background: transparent;">
                    <div class="card-header" style="background: transparent;">
                      <i class="fas fa-map-marker-alt"></i> Locations</div>
                      <center>
                          <a style="margin-top: 10px;" href="#" class="btn-sm btn btn-outline-info" data-toggle="modal" data-target="#staticModal"><i class="fas fa-plus"></i> Add New Location</a>
                      </center>
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  if ($res['status']=='available') {
                                        ...
                                        if ($res['status']=='available') {
                                            echo "<td>
                                                 <a class=\"btn btn-sm btn-outline-primary btn-block\" href=\"viewUser.php\">Add Reservation</a> 
                                                  <a class=\"btn btn-sm btn-outline-info btn-block\" href=\"editLoc.php?loc_id=$res[loc_id]\">Edit Details</a> 
                                                 <a class=\"btn btn-sm btn-outline-danger btn-block\" href=\"deleteLocation.php?loc_id=$res[loc_id]\" onClick=\"return confirm('Are you sure that you want to delete this location details?' )\">Delete</a> 
                                              </td>";
                                          }else{
                                             echo "<td>
                                               <a class=\"btn btn-sm btn-outline-info btn-block\" href=\"editLoc.php?loc_id=$res[loc_id]\">Edit Details</a> 
                                                 <a class=\"btn btn-sm btn-outline-warning btn-block\" href=\"viewLocDetails.php?loc_id=$res[loc_id]\">VIew Details</a> 
                                              </td>";
                                          }
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel"><i class="fas fa-plus"></i> Add New Location</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                           <form id="location" method="post" action="location.php">

                        <div class="form-group">
                          <div class="form-row">
                            <div class="col-md-6 validate">
                              <div class="form-label-group">
                                <label for="firstName">Enter Block</label>
                                <input type="text" id="firstName" class="form-control" autofocus="autofocus" name="block"> 
                              </div>
                            </div>
                            <div class="col-md-6 validate">
                              <div class="form-label-group">
                                <label for="middleName">Enter Number</label>
                                <input type="text" id="middleName" autofocus="autofocus" class="form-control" name="number">
                              </div>
                            </div>
                          </div>
                        </div>    
                            ...
                            <div class="col-md-12 validate">
                              <div class="form-label-group">
                                ...
                                <input type="text" id="price" autofocus="autofocus" class="form-control" name="price">
                              </div>
                            </div>  
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                             <button  class="btn btn-primary btn-sm" type="submit" name="addLocation">Add</button>
                        </div>
                    </form>
                    </div>
                </div>
