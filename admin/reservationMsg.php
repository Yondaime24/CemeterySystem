    ...
    <form id="messageForm" action="reservationMsg.php" method="post">
      ...
      ?>
            ...
            <div class="form-group">
              ...
              <input id="asdasd" name="date_of_burial" type="text" class="form-control" value="<?php echo date('F j, Y',strtotime($row['date_of_burial'])); ?>" readonly>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="row" style="margin-bottom: 10px;">
                <div class="col-6">
                  <a href="viewProfile.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-outline-primary btn-sm btn-block">View Profile</a>
                </div>
                <div class="col-6">
                   <a href="viewReservation.php?reserve_id=<?php echo $row['reserve_id']; ?>" class="btn btn-outline-info btn-sm btn-block">View Reservation</a>
                </div>
             </div>
          ...
          <?php }?>
              ...
              <div>
                <button  class="btn btn-success btn-block" type="submit" name="adminReservationReply">Send Reply</button>
              </div>
