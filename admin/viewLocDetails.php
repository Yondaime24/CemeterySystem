  ...
  <div class="page-wrapper">
        ...
        <form id="reservationForm" action="viewLocDetails.php" method="post">
            ...
            <div class="row">
             ...
             <div class="form-group validate">
              ...
              <div>
                 <a class="btn btn-success btn-block" href="approveReservation.php?reserve_id=<?php echo $row['reserve_id']; ?>&&loc_id=<?php echo $row['loc_id']; ?>" onClick="return confirm('Are you sure you want to Approve this reservation?' )"></i>Approve Reservation</a>
              </div>
               <div style="margin-top: 10px;">
                <a class="btn btn-danger btn-block" href="denyReservation.php?reserve_id=<?php echo $row['reserve_id']; ?>&&loc_id=<?php echo $row['loc_id']; ?>" onClick="return confirm('Are you sure you want to Deny this reservation?' )"></i>Deny Reservation</a>
              </div>
               <div style="margin-top: 10px;">
              ...
              <div style="margin-top: 10px;">
                <a class="btn btn-block btn-secondary" href="location.php">Cancel</a>
              </div>
        </form>
    ...
    <?php }else if($row['status']=='approved'){ ?>
      ...
      <span style="color: #2ecc71">Status: <b><u>Approved</u></b></span>
        ...
        <form id="reservationForm" action="viewLocDetails.php?reserve_id=<?php echo $row['reserve_id']; ?>&&loc_id=<?php echo $row['loc_id']; ?>" method="post">
