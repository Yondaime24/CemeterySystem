...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/images/logo.png">
     ...
     <title>Cemetery System | Dashboard</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="section__content section__content--p30">
            ...
            <section class="statistic">
                <center>
                <img class="image" src="../assets/images/logo.png" width="100px">
                <form style="margin-top: 10px; width: 60%; height: 60px;" id="searchbox" method="post">
                  <div class="box">
                  <div class="input-group">
                    <input style="height: 50px" type="text" name="search" class="form-control box" placeholder="Enter Full Name To Search Deceased Details..." aria-label="Search" aria-describedby="basic-addon2" >
