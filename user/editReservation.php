...
<body class="animsition">
  <div class="page-wrapper">
    ...
    <form id="reservationForm" action="editReservation.php" method="post">
          ...
          ?>
            ...
            <center>
             ...
             <div class="form-group validate" hidden="">
                <label for="reserveID" class="control-label mb-1">Reserve ID</label>
                <input id="reserveID" name="reserve_id" type="text" class="form-control" value="<?php echo $row['reserve_id'];?>">
            </div>

                          
            <div class="form-group validate">
                <label for="inputName" class="control-label mb-1">Deceased Name</label>
                <input id="inputName" name="fullname" type="text" class="form-control" value="<?php echo $row['fullname'];?>">
            </div>
            ...
            <div class="row">
             ...
             <div class="form-group validate">
                <label for="inputBurial" class="control-label mb-1">Select Date of Burial</label>
                <input id="inputBurial" name="date_of_burial" type="date" class="form-control" value="<?php echo strftime('%Y-%m-%d', strtotime($row['date_of_burial'])); ?>">
            </div>

            <?php }?>

              <div>
                <button  class="btn btn-primary btn-block" type="submit" name="updateReservation">Update</button>
              </div>
