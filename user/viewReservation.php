    ...
    <form id="reservationForm" action="reservationForm.php" method="post">
          ...
          <?php }?>
            ...
            <div class="form-group validate">
                ...
                <input id="inputName" name="fullname" type="text" class="form-control" value="<?php echo $row['fullname'];?>" readonly>
            </div>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group validate">
                 ...
                 <input name="age" id="inputAge" type="text" class="form-control" value="<?php echo $row['age'];?>" readonly>
                </div>
              </div>
               <div class="col-6">
                <div class="form-group validate">
                ...
                <div class="form-check-inline form-check"> 
                    ...
                    <input onclick="return false;" type="radio" id="inline-radio2" name="gender" value="Male" class="form-check-input"
                     <?php  
                          if ($row['gender'] == 'Male') {
                            echo "checked";
                          }
                    ...
                    <label for="inline-radio2" class="form-check-label ">
                    <input onclick="return false;" type="radio" id="inline-radio2" name="gender" value="Female" class="form-check-input" style="margin-left: 40px;"
                        <?php  
          ...
          ?>
            <center>
              <h4 style="color: red">Reservation Denied!</h4>
            </center>
          <?php }else if($status=="approved"){ ?> 
            <center>
              <h4 style="color: #2ecc71">Reservation Approved!</h4>
            </center>
          <?php }else if($status=="occupied"){ ?> 
            <center>
              <h4 style="color: black">Reservation Occupied!</h4>
             </center>
          <?php
            }else{
          ?>
              <div>
                <a class="btn btn-block btn-success" href="editReservation.php?reserve_id=<?php echo $row['reserve_id'];?>&&loc_id=<?php echo $row['loc_id'];?>">Edit</a>
              </div>
         <?php }
          ?>
           <?php }?>
